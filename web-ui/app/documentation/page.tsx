          ...
          <div className="prose prose-invert max-w-none space-y-12">
            ...
            <section>
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border mb-6">
                ...
                <ol className="list-decimal list-inside text-gray-200 space-y-3 ml-4">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="bg-dark-card p-4 rounded-lg border border-dark-border">
                  ...
                  <p className="text-gray-200 text-sm">Specialize in gathering and analyzing information</p>
                </div>
                <div className="bg-dark-card p-4 rounded-lg border border-dark-border">
                  <h4 className="font-semibold text-gray-300 mb-2">Writing Agents</h4>
                  <p className="text-gray-200 text-sm">Focus on creating well-structured, engaging content</p>
                </div>
                <div className="bg-dark-card p-4 rounded-lg border border-dark-border">
                  <h4 className="font-semibold text-gray-300 mb-2">Quality Agents</h4>
                  <p className="text-gray-200 text-sm">Ensure accuracy, coherence, and completeness</p>
                </div>
                <div className="bg-dark-card p-4 rounded-lg border border-dark-border">
                  <h4 className="font-semibold text-gray-300 mb-2">Specialized Agents</h4>
                  <p className="text-gray-200 text-sm">Handle specific content types and formats</p>
                </div>
              </div>
            </section>
