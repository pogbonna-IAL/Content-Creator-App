    ...
    <div className="min-h-screen flex flex-col bg-dark-bg">
      ...
      <main className="flex-1 container mx-auto px-4 py-8 max-w-4xl">
        <div className="glass-effect neon-border rounded-2xl p-8">
          ...
          <p className="text-gray-400 mb-2">Last Updated: December 18, 2024</p>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border mb-6">
                ...
                <p className="text-gray-400 mb-4"><strong className="text-white">Price:</strong> $0/month</p>
                <p className="text-gray-400 mb-4"><strong className="text-white">Features:</strong></p>
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border mb-6">
                ...
                <p className="text-gray-400 mb-4"><strong className="text-white">Price:</strong> $9.99/month or $99/year (save 17%)</p>
                <p className="text-gray-400 mb-4"><strong className="text-white">Features:</strong></p>
                <ul className="list-disc list-inside text-gray-400 space-y-2 mb-4 ml-4">
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border mb-6">
                ...
                <p className="text-gray-400 mb-4"><strong className="text-white">Price:</strong> $29.99/month or $299/year (save 17%)</p>
                <p className="text-gray-400 mb-4"><strong className="text-white">Features:</strong></p>
                <ul className="list-disc list-inside text-gray-400 space-y-2 mb-4 ml-4">
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border mb-6">
                ...
                <p className="text-gray-400 mb-4"><strong className="text-white">Price:</strong> Custom pricing (contact sales)</p>
                <p className="text-gray-400 mb-4"><strong className="text-white">Features:</strong></p>
                <ul className="list-disc list-inside text-gray-400 space-y-2 mb-4 ml-4">
                  <li>Unlimited content generations</li>
