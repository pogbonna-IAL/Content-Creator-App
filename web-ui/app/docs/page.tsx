        ...
        <div className="glass-effect neon-border rounded-2xl p-8">
          ...
          <section id="account" className="mb-12">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p className="text-gray-200 mb-3">If you already have an account:</p>
              <ol className="list-decimal list-inside text-gray-200 space-y-2 mb-6">
          ...
          <section id="generating" className="mb-12">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <div className="bg-dark-card p-4 rounded-lg mb-6 border border-dark-border">
                ...
                <ul className="list-disc list-inside text-gray-200 text-sm space-y-1 mb-3">
          ...
          <section id="content-types" className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 mb-3"><strong className="text-white">Best for:</strong> Long-form articles, blog posts</p>
                <ul className="list-disc list-inside text-gray-200 text-sm space-y-1">
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 mb-3"><strong className="text-white">Best for:</strong> Social media posts, tweets, LinkedIn posts</p>
                <ul className="list-disc list-inside text-gray-200 text-sm space-y-1">
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 mb-3"><strong className="text-white">Best for:</strong> Podcast scripts, audio narrations</p>
                <ul className="list-disc list-inside text-gray-200 text-sm space-y-1">
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 mb-3"><strong className="text-white">Best for:</strong> Video scripts, YouTube content</p>
                <ul className="list-disc list-inside text-gray-200 text-sm space-y-1">
          ...
          <section id="tips" className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 text-sm mb-2">✅ <strong>Good:</strong> "5 ways to improve productivity using AI tools in 2024"</p>
                <p className="text-gray-200 text-sm">❌ <strong>Bad:</strong> "Productivity"</p>
              </div>

              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                <h3 className="text-lg font-semibold text-gray-300 mb-2">2. Provide Context</h3>
                <p className="text-gray-200 text-sm">Include relevant details like target audience, purpose, key points, and desired tone.</p>
              </div>

              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                <h3 className="text-lg font-semibold text-gray-300 mb-2">3. Be Patient</h3>
                <p className="text-gray-200 text-sm">Content generation can take several minutes. The AI agents are researching and creating comprehensive content. Don't refresh the page during generation.</p>
              </div>

              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                <h3 className="text-lg font-semibold text-gray-300 mb-2">4. Review and Edit</h3>
                <p className="text-gray-200 text-sm">Always review generated content, edit as needed for your specific use case, and add your personal touch and brand voice.</p>
              </div>
            </div>
          </section>
          ...
          <section id="troubleshooting" className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 text-sm mb-2"><strong>Solutions:</strong></p>
              ...
              <div className="bg-dark-card p-6 rounded-lg border border-dark-border">
                ...
                <p className="text-gray-200 text-sm mb-2"><strong>Note:</strong> This is normal - comprehensive content can take 5-15 minutes.</p>
                <ul className="list-disc list-inside text-gray-200 text-sm space-y-1 ml-4">
