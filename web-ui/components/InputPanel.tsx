...
export default function InputPanel({ onGenerate, onStop, isLoading }: InputPanelProps) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex-1 neon-button px-6 py-3 sm:py-3 rounded-lg font-semibold
          ...
          {isLoading && onStop && (
            <button
              type="button"
              onClick={onStop}
              className="px-6 py-3 sm:py-3 rounded-lg font-semibold
